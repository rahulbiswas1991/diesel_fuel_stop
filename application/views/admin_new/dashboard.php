                     ...
                     <div id="cardbox1">
                        <div class="statistic-box">
                           ...
                           <div class="counter-number pull-right">
                              <span class="count-number"><?=$tot_users?></span> 
                  ...
                  <div class=" col-sm-6 col-md-6 col-lg-3">
                     <div id="cardbox2">
                        <div class="statistic-box">
                           ...
                           <div class="counter-number pull-right">
                              <span class="count-number"><?=$today_users?></span> 
                              <span class="slight"><i class="fa fa-play fa-rotate-270"> </i>
                              </span>
                           </div>
                     ...
                     <div id="cardbox3">
                        <div class="statistic-box">
                           ...
                           <div class="counter-number pull-right">
                              ...
                              <span class="count-number"><?=number_format($tot_buy['total_purchase'],0)?></span> 
                              <span class="slight"><i class="fa fa-play fa-rotate-270"> </i>
                              </span>
                           </div>
                           <h3>  Total Leads</h3>
                  ...
                  <div class=" col-sm-6 col-md-6 col-lg-3">
                     <div id="cardbox4">
                        <div class="statistic-box">
                           ...
                           <div class="counter-number pull-right">
                              <span class="count-number"><?=number_format($today_buy['total_purchase'],0)?></span> 
                              <span class="slight"><i class="fa fa-play fa-rotate-270"> </i>
                              </span>
                           </div>
                           <h3> Today's Leads</h3>
